...
# Creating word_count helper function. We get some text, split by spaces... 
# then count all the elements of the list returned by split(' ')
def word_count(sample): 
    split_sample = sample.split(' ')
    l = len(split_sample)
    print(f'Word count: {l}')

    return l # Return the length of the array of split strings. This is our word count.
